  ...
  return (
    ...
    >
        ...
        <div className="mt-6 flex items-center gap-4 md:mt-8 lg:mt-10">
          <div
            ...
            style={{
              ...
              boxShadow: isHovered ? "0 8px 32px rgba(255, 255, 255, 0.15)" : "0 0 0 transparent",
              transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)",
            }}
          >
            <ArrowUpRight
          ...
          <span
            className="text-[10px] font-medium uppercase tracking-widest text-white transition-all duration-700 md:text-xs"
            style={{
      ...
      >
        ...
        <div className="relative h-[280px] w-[260px] overflow-hidden sm:h-[320px] sm:w-[300px] md:h-[360px] md:w-[320px] lg:h-[420px] lg:w-[380px] rounded-lg">
          <div
            className="absolute -inset-1 transition-all duration-700"
            style={{
              boxShadow: isHovered ? "0 24px 64px rgba(0, 0, 0, 0.5)" : "0 0 0 transparent",
              transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)",
            }}
          />
          <img
          ...
          <div
            className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent transition-opacity duration-700"
            style={{
          ...
          {/* Corner accents */}
          <div
            className="absolute left-4 top-4 h-5 w-px bg-white/80 transition-all duration-500 md:left-6 md:top-6 md:h-6"
            style={{
              opacity: isHovered ? 1 : 0,
          ...
          />
          <div
            className="absolute left-4 top-4 h-px w-5 bg-white/80 transition-all duration-500 md:left-6 md:top-6 md:w-6"
            style={{
              opacity: isHovered ? 1 : 0,
          ...
          />
          <div
            className="absolute bottom-4 right-4 h-5 w-px bg-white/80 transition-all duration-500 md:bottom-6 md:right-6 md:h-6"
            style={{
              opacity: isHovered ? 1 : 0,
              transform: isHovered ? "scaleY(1)" : "scaleY(0)",
          ...
          />
          <div
            className="absolute bottom-4 right-4 h-px w-5 bg-white/80 transition-all duration-500 md:bottom-6 md:right-6 md:w-6"
            style={{
              opacity: isHovered ? 1 : 0,
              transform: isHovered ? "scaleX(1)" : "scaleX(0)",
