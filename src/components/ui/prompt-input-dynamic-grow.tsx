    ...
    <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg overflow-hidden z-30 min-w-[120px]">
      <ul className="py-1">
        {menuOptions.map((option) => (
          <li
            key={option}
            className="px-4 py-2 hover:bg-gray-100 cursor-pointer text-[#0A1217] text-sm font-medium"
  ...
  return (
    <div className="flex-1 relative h-full flex items-center">
      <textarea
        ...
        rows={1}
        className="w-full min-h-8 max-h-24 bg-transparent text-sm font-normal text-left self-center text-white placeholder-white/20 border-0 outline-none px-3 pr-10 py-1 z-20 relative resize-none overflow-y-auto"
        style={{
  ...
  return (
    <ChatInputContext.Provider value={contextValue}>
      <form
        ...
        className={`z-50 mx-auto min-h-12 ${baseWidthClass} transition-all duration-${animationDuration} ease-out ${focusWidthClass}`}
        style={{
      ...
      >
        <div
          ...
          onClick={handleClick}
          className="relative flex flex-col w-full min-h-full bg-white/5 backdrop-blur-xl shadow-lg rounded-[24px] p-2 overflow-visible group transition-all duration-300 border border-white/10"
          style={{
            boxShadow:
