...
export function AIFirstSection() {
  ...
  return (
    ...
    >
      {/* Top Transition Blur */}
      <div
        className="absolute top-0 left-0 w-full h-20 z-30 pointer-events-none"
        style={{
      ...
      {/* Decorador de Fundo (Imagem Macro Abstrata Gerada e Gradiente) */}
      <div
      ...
      <div className="container-premium relative z-10 mt-12 md:mt-0">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:items-end">

          {/* Coluna Esquerda: Elemento Visual e Parallax - DESLOCADO PARA A DIREITA */}
          <div className="md:col-span-6 md:col-start-3 relative min-h-[400px] md:min-h-[500px] flex flex-col justify-end">
            ...
            {/* Card de Citação - AGORA MAIS PRÓXIMO DO MANIFESTO */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative z-10 pl-6 md:ml-auto md:mr-[-4rem] md:max-w-xs mb-10 mt-64 md:mt-0"
            >
              {/* Tracinho Decorativo Lateral - PUXADO PARA A ESQUERDA */}
              <div className="absolute left-[-3rem] top-0 bottom-0 w-[2px] bg-[#C9A84C]/50" />
              ...
              <span className="text-[10px] md:text-xs text-gray-500 uppercase tracking-[0.3em] font-bold">
          ...
          <div className="md:col-span-4 md:col-start-9 flex flex-col gap-8">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h3 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-2 tracking-tight">
                Não adicionamos IA ao seu negócio.
              </h3>
              <h4 className="text-4xl md:text-6xl font-bold text-[#C9A84C] italic leading-tight tracking-tight whitespace-nowrap">
                Redesenhamos ele.
              </h4>
            </motion.div>

            <div className="space-y-6 text-base md:text-lg text-gray-400 leading-relaxed font-light">
              <p>
                A maioria das empresas adiciona IA como se fosse um acessório. Coloca por cima do que já existe e espera milagre.
              </p>

              <div className="py-4">
                <h5 className="text-white text-xl md:text-2xl font-bold mb-3">Nós redesenhamos.</h5>
                <p>
